<div class="site-footer">
				...
				<div class="col-lg-4">
					...
					<div class="widget">
						...
						<ul class="list-unstyled social">
							...
							<li><a href="javascript:void(0)"><span class="icon-pinterest"></span></a></li>
							<li><a href="javascript:void(0)"><span class="icon-dribbble"></span></a></li>
						</ul>
					</div> <!-- /.widget -->
				</div> <!-- /.col-lg-3 -->
		...
		<script src="<?= THEME_JS . '/bootstrap.bundle.min.js'?>"></script>
		<script src="<?= THEME_JS . '/tiny-slider.js'?>"></script>
		<script src="<?= THEME_JS . '/aos.js'?>"></script>
		<script src="<?= THEME_JS . '/navbar.js'?>"></script>
		<script src="<?= THEME_JS . '/counter.js'?>"></script>
		<script src="<?= THEME_JS . '/rellax.js'?>"></script>
		<script src="<?= THEME_JS . '/flatpickr.js'?>"></script>
		<script src="<?= THEME_JS . '/glightbox.min.js'?>"></script>
		<script src="<?= THEME_JS . '/custom.js'?>"></script>
