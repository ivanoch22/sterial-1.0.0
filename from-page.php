<?php get_header();?>
	...
	<div class="hero overlay">
		...
		<div class="img-bg rellax">
			<img src="<?= THEME_IMG . '/hero_1.jpg'?>" alt="Image" class="img-fluid">
		</div>
				...
				<div class="col-lg-6 order-lg-2 mb-5 mb-lg-0">
					<div class="image-stack mb-5 mb-lg-0">
						<div class="image-stack__item image-stack__item--bottom" data-aos="fade-up"  >
							<img src="<? THEME_IMG . '/img_v_1.jpg'?>" alt="Image" class="img-fluid rellax ">
						</div>
						<div class="image-stack__item image-stack__item--top" data-aos="fade-up" data-aos-delay="100"  data-rellax-percentage="0.5">
							<img src="<? THEME_IMG . '/img_v_2.jpg'?>" alt="Image" class="img-fluid">
						</div>
					</div>
				...
				<div class="col-lg-9">
					<div class="row">
						<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up"  data-aos-delay="100">
							<div class="service-1">
								<span class="icon">
									<img src="<? THEME_IMG . '/svg/01.svg'?>" alt="Image" class="img-fluid">
								</span>
								<div>
									<h3>Tourism</h3>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						...
						<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up"  data-aos-delay="200">
							<div class="service-1">
								<span class="icon">
									<img src="<? THEME_IMG . '/svg/02.svg'?>" alt="Image" class="img-fluid">
								</span>
								<div>
									<h3>Package Tours</h3>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						...
						<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up"  data-aos-delay="300">
							<div class="service-1">
								<span class="icon">
									<img src="<? THEME_IMG . '/svg/03.svg'?>" alt="Image" class="img-fluid">
								</span>
								<div>
						...
						<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up"  data-aos-delay="400">
							<div class="service-1">
								<span class="icon">
									<img src="<? THEME_IMG . '/svg/04.svg'?>" alt="Image" class="img-fluid">
								</span>
								<div>
		...
		<div class="destination-slider-wrap">
			<div class="destination-slider">
				<div class="destination">
					<div class="thumb">
						<img src="<? THEME_IMG . '/img-1.jpg'?>" alt="Image" class="img-fluid">
				...
				<div class="destination">
					<div class="thumb">
						<img src="<? THEME_IMG . '/img-2.jpg'?>" alt="Image" class="img-fluid">
				...
				<div class="destination">
					<div class="thumb">
						<img src="<? THEME_IMG . '/img-3.jpg'?>" alt="Image" class="img-fluid">
				...
				<div class="destination">
					<div class="thumb">
						<img src="<? THEME_IMG . '/img-4.jpg'?>" alt="Image" class="img-fluid">
						<div class="price">$490</div>
					</div>
					<div class="mt-4">
						<h3><a href="#">Paradise Beach, Palawan Island</a></h3>
				...
				<div class="destination">
					<div class="thumb">
						<img src="<? THEME_IMG . '/img-5.jpg'?>" alt="Image" class="img-fluid">
						<div class="price">$430</div>
					</div>
					<div class="mt-4">
						<h3><a href="#">Paradise Beach, Palawan Island</a></h3>
				...
				<div class="destination">
					<div class="thumb">
						<img src="<? THEME_IMG . '/img-6.jpg" alt="Image'?>" class="img-fluid">
						<div class="price">$560</div>
					</div>
					<div class="mt-4">
						<h3><a href="#">Paradise Beach, Palawan Island</a></h3>
				...
				<div class="destination">
					<div class="thumb">
						<img src="<? THEME_IMG . '/img-7.jpg'?>" alt="Image" class="img-fluid">
						<div class="price">$490</div>
					</div>
					<div class="mt-4">
						<h3><a href="#">Paradise Beach, Palawan Island</a></h3>
		...
		<div class="container">
			<div class="row justify-content-between align-items-center">
				<div class="col-lg-5 mb-4 mb-lg-0 order-lg-2" data-aos="fade-up">
					<img src="<? THEME_IMG . 'i/img-1.jpg'?>" alt="Image" class="img-fluid">
				</div>
			...
			<div class="wide-slider-testimonial">
				<div class="item">
					<blockquote class="block-testimonial">
						<div class="author">
							<img src="<? THEME_IMG . '/person_1.jpg'?>" alt="Free template by TemplateUX">
							<h3>John Doe</h3>
							<p class="position mb-5">CEO, Founder</p>
						</div>
						<p> <div class="quote">&ldquo;</div>
				...
				<div class="item">
					<blockquote class="block-testimonial">
						<div class="author">
							<img src="<?= THEME_IMG . '/person_3.jpg'?>" alt="Free template by TemplateUX">
							<h3>Rob Smith</h3>
				...
				<div class="item">
					<blockquote class="block-testimonial">
						<div class="author">
							<img src="<?= THEME_IMG . '/person_2.jpg'?>" alt="Free template by TemplateUX">
							<h3>James Woodland</h3>
							<p class="position mb-5">Designer at Facebook</p>
						</div>
						<p>
			...
			<div class="row align-items-stretch">
				<div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
					<div class="media-entry">
						<a href="#">
							<img src="<?= THEME_IMG . '/gal_1.jpg'?>" alt="Image" class="img-fluid">
						</a>
				...
				<div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
					<div class="media-entry">
						<a href="#">
							<img src="<?= THEME_IMG . '/gal_2.jpg'?>" alt="Image" class="img-fluid">
						</a>
						<div class="bg-white m-body">
							<span class="date">May 14, 2020</span>
							<h3><a href="#">Far far away, behind the word mountains</a></h3>
				...
				<div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
					<div class="media-entry">
						<a href="#">
							<img src="<? THEME_IMG . '/gal_3.jpg'?>" alt="Image" class="img-fluid">
						</a>
						<div class="bg-white m-body">
							<span class="date">May 14, 2020</span>
							<h3><a href="#">Far far away, behind the word mountains</a></h3>
				...
				<div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
					<div class="media-entry">
						<a href="#">
							<img src="<?= THEME_IMG . '/gal_4.jpg'?>" alt="Image" class="img-fluid">
						</a>
						<div class="bg-white m-body">
							<span class="date">May 14, 2020</span>
							<h3><a href="#">Far far away, behind the word mountains</a></h3>
