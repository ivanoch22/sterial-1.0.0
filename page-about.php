				...
				<div class="col-lg-6 order-lg-2 mb-5 mb-lg-0">
					<div class="image-stack mb-5 mb-lg-0">
						<div class="image-stack__item image-stack__item--bottom" data-aos="fade-up"  >
							<img src="<?= THEME_IMG . 'images/img_v_1.jpg'?>" alt="Image" class="img-fluid rellax ">
						</div>
						<div class="image-stack__item image-stack__item--top" data-aos="fade-up" data-aos-delay="100"  data-rellax-percentage="0.5">
							<img src="<?= THEME_IMG . 'images/img_v_2.jpg'?>" alt="Image" class="img-fluid">
						</div>
					</div>
	...
	<div class="section">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3">
					<a href="#" class="person">
						<img src="<?= THEME_IMG . '/person_1.jpg'?>" alt="Image" class="img-fluid mb-4">
				...
				<div class="col-lg-3">
					<a href="#" class="person">
						<img src="<?= THEME_IMG . '/person_2.jpg'?>" alt="Image" class="img-fluid mb-4">
						<span class="subheading d-inline-block">CEO, Co-Founder</span>
				...
				<div class="col-lg-3">
					<a href="#" class="person">
						<img src="<?= THEME_IMG . 'images/person_3.jpg'?>" alt="Image" class="img-fluid mb-4">
						<span class="subheading d-inline-block">CEO, Co-Founder</span>
