	...
	<div class="hero overlay">
		...
		<div class="img-bg rellax">
			<img src="<?= THEME_IMG . '/hero_2.jpg'?>" alt="Image" class="img-fluid">
		</div>
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3">
					<div class="service-2 left-0 mb-5">
						<img src="<?= THEME_IMG . '/gal_5.jpg'?>" alt="Image" class="img-fluid mb-4 rounded">
						<div>
							<h3>Airport Lounge Access</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
				...
				<div class="col-lg-3">
					<div class="service-2 left-0 mb-5">
						<img src="<?= THEME_IMG . '/gal_6.jpg'?>" alt="Image" class="img-fluid mb-4 rounded">
						<div>
							<h3>Airport Lounge Access</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<p><a href="#" class="more">Learn More</a></p>
				...
				<div class="col-lg-3">
					<div class="service-2 left-0 mb-5">
						<img src="<?= THEME_IMG . '/gal_3.jpg'?>" alt="Image" class="img-fluid mb-4 rounded">
						<div>
							<h3>Airport Lounge Access</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<p><a href="#" class="more">Learn More</a></p>
				...
				<div class="col-lg-3">
					<div class="service-2 left-0 mb-5">
						<img src="<?= THEME_IMG . '/gal_4.jpg'?>" alt="Image" class="img-fluid mb-4 rounded">
						<div>
							<h3>Airport Lounge Access</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<p><a href="#" class="more">Learn More</a></p>
